...
export default class SignUp extends Component {
    ...
    componentDidMount() {
        ...
        // WARNING: Causes memory leak when user leaves page and returns with refreshing.
                ...
                <form className="signup_form">
                    ...
                    <fieldset className="signup_fieldset">
                        ...
                        <div className="pay_with">
                            <button className="paypal_button" type="button">Pay with PayPal</button>
                            <p>Or</p>
                            <button className="bitcoin_button" type="button">Pay with Bitcoin</button>
                        </div>
                    </fieldset>
                    <p className="agreement">By signing up, you automatically agree to our <Link to="privacy_policy">Privacy Policy</Link> and <Link to="terms_of_service">Terms Of Service</Link>.</p>
                </form>
        </React.Fragment> );
    }
}