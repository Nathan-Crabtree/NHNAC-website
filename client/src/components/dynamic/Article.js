                        ...
                        <section className="comment_container">
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    magna aliqua.</p>
                                    <form id="comment_1_0" className="comment_form_1_0" onSubmit={ this.onSubmit }>
                                        <fieldset>
                                    ...
                                    <div className="response_section_container">
                                        <section className="response_container">
                                            <div>
                                                ...
                                                <div>
                                                    ...
                                                    sed do eiusmod tempor incididunt ut labore et dolore 
                                                    magna aliqua.</p>
                                                    <form id="comment_1_1" className="comment_form_1_1" onSubmit={ this.onSubmit }>
                                                        <fieldset>
                                                            <div className="comment_form_field">
                                                                <label htmlFor="comment">Comment</label>
                                        ...
                                        <form id="response" className="response_form" onSubmit={ this.onSubmit }>
                                            <fieldset>
                                                <div className="comment_form_field">
                ...
                <div>
                    <div className="blur_container">
                        ...
                        <div className="comment_section_container">
                            <section className="comment_container">
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        sed do eiusmod tempor incididunt ut labore et dolore 
                                        magna aliqua.</p>
                                        <form id="comment_1_0_unauth" className="comment_form_1_0" onSubmit={ this.onSubmit }>
                                            <fieldset>
                                                <div className="comment_form_field">
                                                    <label htmlFor="comment">Comment</label>
                                                    <svg onClick={ () => { this.hideForm("comment_form_1_0", "comment_content_1_0", true) } } className="_modal-close-icon" viewBox="0 0 40 40">
                                                    ...
                                                    <textarea className="login_input" type="text" id="comment_1_0_unauth_textarea" name="comment" readOnly value="Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
                                                    sed do eiusmod tempor incididunt ut labore et dolore 
                                                    magna aliqua." /><br />
                                                </div>
                                                <button className="submit_btn submit_padding" type="submit">Submit</button>
                                        ...
                                        <div className="response_section_container">
                                            <section className="response_container">
                                                <div>
                                                    ...
                                                    <div>
                                                        ...
                                                        sed do eiusmod tempor incididunt ut labore et dolore 
                                                        magna aliqua.</p>
                                                        <form id="comment_1_1_unauth" className="comment_form_1_1" onSubmit={ this.onSubmit }>
                                                            <fieldset>
                                                                <div className="comment_form_field">
                                                                    <label htmlFor="comment">Comment</label>
                                                                    <svg onClick={ () => { this.hideForm("comment_form_1_1", "comment_content_1_1", true, true) } } className="_modal-close-icon" viewBox="0 0 40 40">
                                                                    ...
                                                                    <textarea className="login_input" type="text" id="comment_1_1_unauth_textarea" name="comment" readOnly value="Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
                                                                    sed do eiusmod tempor incididunt ut labore et dolore 
                                                                    magna aliqua." /><br />
                                                                </div>
                                                                <button className="submit_btn submit_padding" type="submit">Submit</button>
                                            ...
                                            <form id="response_unauth" className="response_form" onSubmit={ this.onSubmit }>
                                                <fieldset>
                                                    <div className="comment_form_field">
                                                        <label htmlFor="comment">Response</label>
                                                        <svg onClick={ () => { this.hideForm("response_form", "comment_btn")} } className="_modal-close-icon" viewBox="0 0 40 40">
                                                        ...
                                                        <textarea className="login_input" type="text" id="response_unauth_textarea" name="comment" /><br />
                                                    </div>
                                                    <button className="submit_btn submit_padding" type="submit">Submit</button>
                                                </fieldset>
                                            </form>
                            ...
                            <form id="comment_unauth" className="comment_form" onSubmit={ this.onSubmit }>
                                <fieldset>
                                    <div className="comment_form_field">
                                        <label htmlFor="comment">Comment</label>
                                        <svg onClick={ () => { this.hideForm("comment_form", "see_comments_btn") }} className="_modal-close-icon" viewBox="0 0 40 40">
                                        ...
                                        <textarea className="login_input" type="text" id="comment_unauth_textarea" name="comment" /><br />
                                    </div>
                                    <button className="submit_btn submit_padding" type="submit">Submit</button>
                                </fieldset>
                            </form>
